...
// lets make a random image generator for our cards
...
const card_image = document.querySelectorAll(".front");

card_image.style.background-image("url"(getRandom(random_card)));